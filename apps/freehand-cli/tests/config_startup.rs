...
fn phase2a_agent_lifecycle(
    ...
    UiAgentLifecycleProjection {
        ...
        alive: true,
        process: Some(Box::new(UiAgentProcessProjection {
            process_id: Some(101),
            process_instance_id: Some(format!("{agent_id}-process-1")),
            started_at: Some(1),
            heartbeat_at: Some(1),
            restart_count: 0,
            next_check_at: Some(6),
        })),
...
fn phase1_agent_lifecycle(state: &str) -> UiAgentLifecycleProjection {
    UiAgentLifecycleProjection {
        ...
        process: Some(Box::new(UiAgentProcessProjection {
            process_id: Some(101),
            process_instance_id: Some("cli-agent-process-1".to_owned()),
            started_at: Some(1),
            heartbeat_at: Some(1),
            restart_count: 0,
            next_check_at: Some(6),
