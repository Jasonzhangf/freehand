...
export const webuiEdges = Object.freeze([
  ...
  {
    id: "home.rename_session",
    from: WebUiSurface.HomeDashboard,
    event: "session.rename",
    to: WebUiSurface.HomeDashboard,
    requires: ["session_id", "title"],
    allowedEffects: ["command_rename_session", "query_session_list"],
    forbiddenEffects: ["browser_local_crud_truth", "mutate_transcript_truth"],
  },
  {
  ...
  {
    id: "home.archive_session",
    from: WebUiSurface.HomeDashboard,
    event: "session.archive",
    to: WebUiSurface.HomeDashboard,
    requires: ["session_id"],
    allowedEffects: ["command_archive_session", "query_session_list"],
    forbiddenEffects: ["browser_local_crud_truth"],
  },
  {
    id: "home.open_search",
    from: WebUiSurface.HomeDashboard,
