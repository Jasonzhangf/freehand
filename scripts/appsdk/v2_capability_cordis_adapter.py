#!/usr/bin/env python3
"""Freehand v2 capability/Cordis AppSDK lifecycle adapter."""
...
def evidence_record(
    *,
    ...
    record = {
        ...
        "producer": {
            "adapter": "freehand-v2-capability-cordis-adapter",
...
def module_config(module_id: str) -> dict:
    if module_id == "v2-plugin-capabilities":
        return {
            "crate": "plugin-capabilities",
            "test_name": "v2_plugin_capabilities_boundary",
            "binary": "v2-plugin-capabilities-public",
            "artifact": "v2-plugin-capabilities.module",
            "issue": "freehand-v2-plugin-capabilities-milestone",
            "worktree": "playground/v2-capability-cordis-20260903",
            "design": "docs/design/v2-plugin-capabilities-owner-binding.md",
            "install_input": [
                {"action": "register", "plugin_id": "memory", "capability_id": "mem.write", "input_contract": "ctx:write", "output_contract": "ctx:result", "events": ["capability.result"], "permissions": ["capability.invoke"]},
                {"action": "invoke", "capability_id": "mem.write", "correlation_id": "c-install", "payload": "install"},
            ],
            "blackbox_input": [
                {"action": "register", "plugin_id": "memory", "capability_id": "mem.write", "input_contract": "ctx:write", "output_contract": "ctx:result", "events": ["capability.result"], "permissions": ["capability.invoke"]},
                {"action": "invoke", "capability_id": "mem.write", "correlation_id": "c-blackbox", "payload": "blackbox"},
            ],
        }
    return {
        "crate": "cordis-ecosystem",
        "test_name": "v2_cordis_ecosystem_boundary",
        "binary": "v2-cordis-public",
        "artifact": "v2-cordis-ecosystem.module",
        "issue": "freehand-v2-cordis-plugin-registry-20260904",
        "worktree": "playground/v2-plugin-registry-20260904",
        "design": "docs/design/v2-cordis-ecosystem-owner-binding.md",
        "install_input": [
            {"action": "register_role", "plugin_id": "ui.run", "role": "ui", "contract_version": 1},
            {"action": "plugins"},
            {"action": "register", "plugin_id": "memory", "capability_id": "mem.write", "input_contract": "ctx:write", "output_contract": "ctx:result", "events": ["capability.result"], "permissions": ["capability.invoke"]},
            {"action": "compose", "capability_id": "mem.write", "correlation_id": "c-install", "payload": "install"},
        ],
        "blackbox_input": [
            {"action": "register_role", "plugin_id": "network.reserved", "role": "network_reserved", "contract_version": 1},
            {"action": "plugins"},
            {"action": "register", "plugin_id": "memory", "capability_id": "mem.write", "input_contract": "ctx:write", "output_contract": "ctx:result", "events": ["capability.result"], "permissions": ["capability.invoke"]},
            {"action": "compose", "capability_id": "mem.write", "correlation_id": "c-blackbox", "payload": "blackbox"},
            {"action": "replace", "plugin_id": "memory2", "capability_id": "mem.write", "input_contract": "ctx:write2", "output_contract": "ctx:result2", "events": ["capability.result"], "permissions": ["capability.invoke"]},
            {"action": "compose", "capability_id": "mem.write", "correlation_id": "c-blackbox-2", "payload": "replacement"},
        ],
    }
...
def main() -> None:
    ...
    parser.add_argument("--module", default="v2-plugin-capabilities")
