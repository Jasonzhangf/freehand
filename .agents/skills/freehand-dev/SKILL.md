...
- Repository-authored online success JSON is never execution provenance. Until a WebUI, Android-device, or no-touch verifier has a source-bound external provenance owner and admission gate, lifecycle promotion through that verifier must fail closed.
