...
- `../goals/mobile-webui-responsive-plan.md`
  - implementation goal plan for aspect-ratio responsive WebUI, Android WebView, and file-backed Tailscale-first daemon config closeout
