...
- WebSocket tunnel opens require typed `RelayDataAccessScope::Remote`; HTTP opens reject any access scope, and the Agent bridge converts the accepted remote scope to the local WebSocket header without copying it into business payloads
