...
- lifecycle path under test:
  ...
  - runtime-backed `QuerySessionListPage` returns one metadata-only owner page and never performs full transcript restoration merely because an unavailable/poisoned summary exists
