...
Generated from `docs/mainline-calls/reason.turn.json`. Do not edit by hand.

- owner crate: `crates/freehand-reason`
- owner module: `crates/freehand-reason/src/lib.rs`
- function map: `docs/function-maps/reason.turn.md`
...
- runtime owners may supply a tool-schema fingerprint to turn startup so planner diagnostics stay aligned with tool registry truth without making reason own tool schemas
...
- `MetadataCenter::write`
  ...
  - related tests: reason producer metadata provenance, request-text isolation, durable-ledger persistence, metadata-write failure tests
