...
| 07 | `instruction_capability_segment` | `crates/freehand-runtime/src/lib.rs` | compile and render instruction capability truth, then admit it as a typed context-planner segment | runtime home plus cwd plus compiled instruction capability manifest | ContextSegmentKind::InstructionCapability request-context segment | runtime live bridge | freehand-instructions::render_instruction_capability_context | instruction_capability | request_context | instruction_capability.admit_request_context | bound |
