...
- usage parsing preserves OpenAI input_tokens or prompt_tokens as normalized total input while mapping compatible cache-read and cache-write detail aliases into cache categories without inflating the denominator
