...
| 02b | `parse_anthropic_usage` | `crates/freehand-provider-anthropic/src/lib.rs` | normalize uncached input plus cache creation and cache read counters into provider-neutral total-input usage | raw Anthropic usage object | provider-neutral TokenUsage | AnthropicAdapter::parse_response / AnthropicAdapter::parse_stream_event | adapter usage parser |  |  |  | bound |
