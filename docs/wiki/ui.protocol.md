...
- tool-call lifecycle is projected as UiToolActivity inside UiTurnProjection: ReasonReq04ToolCall upserts a waiting activity, matching ReasonReq05ToolResultReentry marks the same activity completed, and failed terminal truth marks still-waiting activities failed
